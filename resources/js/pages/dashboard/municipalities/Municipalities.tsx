                ...
                <div className="container mx-auto px-4 py-8 sm:px-6 lg:px-8">
                    <div className="mb-8 flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
                        ...
                        <div className="flex gap-4">
                            <div className="flex min-w-[120px] flex-col items-center rounded-2xl border border-amber-100 bg-white p-4 shadow-sm">
                    ...
                    <div className="mb-8 flex flex-col gap-4 md:flex-row">
                        ...
                        <button
                            ...
                            className="inline-flex items-center rounded-2xl bg-gradient-to-r from-amber-500 to-amber-600 px-8 py-4 font-bold text-white shadow-lg shadow-amber-500/20 transition-all hover:scale-[1.02] active:scale-[0.98]"
                        >
                            ...
                            <table className="w-full">
                                ...
                                <tbody className="divide-y divide-gray-50">
                                    {municipalities.data.map((m) => (
                                        <tr
                                            key={m.id}
                                            className="group transition-all hover:bg-amber-50/30"
                                        >
                                            ...
                                            <td className="px-6 py-5 text-right">
                                                <div className="flex justify-end gap-2 opacity-0 transition-opacity group-hover:opacity-100">
                                                    <button
                                                        ...
                                                        className="rounded-lg p-2 text-amber-600 transition-all hover:bg-amber-50"
                                                    >
                                                        <Edit3 size={18} />
                                                    </button>
                                                    <button
