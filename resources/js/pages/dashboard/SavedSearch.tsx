        ...
        <Dashboard>
            <div className="dashboard__container dashboard__reviews--container">
                <div className="reviews__heading mb-30">
                    ...
                    <p className="reviews__heading--desc">
                    ...
                    <div className="reviews__table table-responsive">
                        <table className="reviews__table--wrapper">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <span className="saved__search--name">
                                    ...
                                    <td>
                                        <div className="reviews__action--wrapper position-relative">
                                            ...
                                            <ul
                                                className="dropdown-menu sold-out__user--dropdown"
                            ...
                            <ul className="pagination__menu d-flex align-items-center justify-content-center">
                                <li className="pagination__menu--items pagination__arrow d-flex">
                                    ...
                                    >
                                        ...
                                        >
                                            <path
                                                d="M10.583 20.5832L0.999675 10.9998L10.583 1.4165"
                                                stroke="currentColor"
                                                strokeWidth={2}
                                            />
                                        </svg>
                                    ...
                                    >
                                        ...
                                        >
                                            <path
                                                d="M11.001 20.5832L1.41764 10.9998L11.001 1.4165"
                                                stroke="currentColor"
                                                strokeWidth={2}
                                            />
                                        </svg>
                                ...
                                <li className="pagination__menu--items">
                                    <a
                                        href="#"
                                        className="pagination__menu--link"
                                    >
                                        01
                                    </a>
                                </li>
                                <li className="pagination__menu--items">
                                    <a
                                        href="#"
                                        className="pagination__menu--link active color-accent-1"
                                    >
                                        02
                                    </a>
                                </li>
                                ...
                                <li className="pagination__menu--items pagination__arrow d-flex">
                                    ...
                                    >
                                        ...
                                        >
                                            <path
                                                d="M1.00098 20.5832L10.5843 10.9998L1.00098 1.4165"
                                                stroke="currentColor"
                                                strokeWidth={2}
                                            />
                                        </svg>
                                    ...
                                    >
                                        ...
                                        >
                                            <path
                                                d="M1.41895 20.5832L11.0023 10.9998L1.41895 1.4165"
                                                stroke="currentColor"
                                                strokeWidth={2}
                                            />
                                        </svg>
