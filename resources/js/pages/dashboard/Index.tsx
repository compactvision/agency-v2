            ...
            <div className="h-full w-full space-y-4 px-2 sm:space-y-6 sm:px-4 lg:space-y-8 lg:px-0">
                ...
                <section ref={statsRef} className="w-full">
                    <div className="grid w-full grid-cols-2 gap-3 sm:grid-cols-2 sm:gap-4 lg:grid-cols-4 lg:gap-6">
                        {/* Properties Card */}
                        <div className="transform rounded-xl border border-slate-200 bg-white p-4 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-md sm:rounded-2xl sm:p-6">
                            <div className="mb-3 flex items-center justify-between sm:mb-4">
                                <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-[#1E3A5F]/10 sm:h-12 sm:w-12">
                                    <Building className="h-5 w-5 text-[#1E3A5F] sm:h-6 sm:w-6" />
                                </div>
                        ...
                        <div className="transform rounded-xl border border-slate-200 bg-white p-4 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-md sm:rounded-2xl sm:p-6">
                            <div className="mb-3 flex items-center justify-between sm:mb-4">
                                <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-[#1E3A5F]/10 sm:h-12 sm:w-12">
                                    <Clock className="h-5 w-5 text-[#1E3A5F] sm:h-6 sm:w-6" />
                                </div>
                        ...
                        <div className="transform rounded-xl border border-slate-200 bg-white p-4 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-md sm:rounded-2xl sm:p-6">
                            <div className="mb-3 flex items-center justify-between sm:mb-4">
                                <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-[#1E3A5F]/10 sm:h-12 sm:w-12">
                                    <Eye className="h-5 w-5 text-[#1E3A5F] sm:h-6 sm:w-6" />
                                </div>
                                <div className="hidden items-center text-xs font-medium text-emerald-600 sm:flex sm:text-sm">
                                    <TrendingUp className="mr-1 h-3 w-3 sm:h-4 sm:w-4" />
                                    +24%
                        ...
                        <div className="transform rounded-xl border border-slate-200 bg-white p-4 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-md sm:rounded-2xl sm:p-6">
                            <div className="mb-3 flex items-center justify-between sm:mb-4">
                                <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-[#1E3A5F]/10 sm:h-12 sm:w-12">
                                    <Heart className="h-5 w-5 text-[#1E3A5F] sm:h-6 sm:w-6" />
                                </div>
                                <div className="hidden items-center text-xs font-medium text-emerald-600 sm:flex sm:text-sm">
                                    <TrendingUp className="mr-1 h-3 w-3 sm:h-4 sm:w-4" />
                                    +8%
                            ...
                            <div className="rounded-xl border border-slate-200 bg-white p-4 shadow-sm sm:rounded-2xl sm:p-6">
                                <div className="mb-4 flex flex-col justify-between gap-3 sm:mb-6 sm:flex-row sm:items-center">
                                    <div className="flex items-center">
                                        <div className="mr-2 flex h-8 w-8 items-center justify-center rounded-xl bg-[#1E3A5F]/10 sm:mr-3 sm:h-10 sm:w-10">
                                ...
                                <div className="grid w-full grid-cols-1 gap-3 sm:gap-4 lg:grid-cols-2">
                                    {recentProperties.length === 0 ? (
                                        <div className="col-span-full py-8 text-center sm:py-12">
                                            <div className="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-2xl bg-slate-100 sm:h-20 sm:w-20">
                                            ...
                                            >
                                                <div className="flex flex-col space-y-2 sm:space-y-3">
                                                    <div className="flex items-start justify-between">
                                                        <h4 className="flex-1 pr-2 text-base font-semibold text-slate-900 transition-colors duration-200 group-hover:text-[#1E3A5F] sm:text-lg">
                                                            {property.title}
                                                        </h4>
                                                        {getStatusBadge(
                                                    ...
                                                    <div className="flex flex-col space-y-2 sm:flex-row sm:items-center sm:space-y-0 sm:space-x-3">
                                                        <span className="inline-flex items-center rounded-lg bg-slate-100 px-2 py-1 text-xs font-medium text-slate-600 sm:px-3">
                                                            <Building className="mr-1 h-3 w-3" />
                                                            {property.type}
                                                        </span>
                                                        <span className="flex items-center text-xs text-slate-600 sm:text-sm">
                                                            <MapPin className="mr-1 h-3 w-3 text-slate-400 sm:h-4 sm:w-4" />
                                                    ...
                                                    <div className="flex items-center justify-between">
                                                        <div className="text-lg font-bold text-[#1E3A5F] sm:text-xl">
                                                            {formatPrice(
                                                                property.price,
                                                            )}
                                                        </div>
                                                        <div className="flex items-center space-x-2 text-xs text-slate-600 sm:space-x-3 sm:text-sm">
                                                            <span className="flex items-center">
                                                                <Eye className="mr-1 h-3 w-3 text-slate-400 sm:h-4 sm:w-4" />
                                                                {property.views_count ||
                                                                    0}
                                                            </span>
                                                            <span className="flex items-center">
                                                                <Heart className="mr-1 h-3 w-3 text-red-400 sm:h-4 sm:w-4" />
                                ...
                                <div className="max-h-64 space-y-3 overflow-y-auto sm:max-h-80 sm:space-y-4 lg:max-h-96">
                                    {logs.length === 0 ? (
                                        <div className="py-6 text-center sm:py-8">
                                            <div className="mx-auto mb-3 flex h-12 w-12 items-center justify-center rounded-2xl bg-slate-100 sm:h-16 sm:w-16">
