                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h2 className="text-xl font-bold text-gray-900">
                                {amenity ? t('edit_amenity') : t('new_amenity')}
                            </h2>
                            <p className="text-sm text-gray-500">
                                {amenity
                                    ? t('update_amenity_description')
                                    : t('add_amenity_description')}
                            </p>
                        </div>
                    </div>
                    <button
                ...
                >
                    <div className="space-y-2">
                        ...
                        <input
                            ...
                            placeholder={t('amenity_name_example')}
                        />
                        {errors.name && (
                    ...
                    <div className="space-y-2">
                        ...
                        <input
                            ...
                            placeholder={t('amenity_icon_example')}
                        />
