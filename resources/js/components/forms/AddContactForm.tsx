            ...
            <div className="modal-dialog modal-dialog-centered">
                <div className="modal-content modal__contact--main__content">
                    <div className="modal__contact--header d-flex align-items-center justify-content-between">
                        <h3 className="modal__contact--header__title">
                            Add Contact
                        </h3>
                        <button
                            type="button"
                            className="modal__contact--close__btn"
                        ...
                        >
                            ...
                            >
                                <g
                                    id="Group_7205"
                                    data-name="Group 7205"
                                    transform="translate(-113.644 -321.644)"
                                >
                                    <path
                                        id="Vector"
                                        d="M0,9.883,9.883,0"
                        ...
                        <div className="modal__contact--form">
                            <form action="#">
                                <div className="modal__contact--form__input mb-20">
                                    <label
                                        className="modal__contact--input__label"
                                        htmlFor="name"
                                    >
                                        Contact Name
                                    </label>
                                    <input
                                        className="modal__contact--input__field"
                                ...
                                <div className="modal__contact--form__input mb-20">
                                    <label className="modal__contact--input__label">
                                        Description
                                    </label>
                                    <textarea
                                        className="modal__contact--textarea__field"
