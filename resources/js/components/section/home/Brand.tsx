export default function Brand() {
    return (
        <div className="brand-9-area h9-bg-secondary">
            <div className="container">
                <div className="row brand-9-row ten-row">
                    <div className="col-xxl-12">
                        <div className="brand-9-slider">
                            <div className="brand-9-active swiper-container">
