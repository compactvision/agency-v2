    ...
    return (
        <section className="testimonial-10-area padding-y-120 h9-bg-secondary position-relative z-index-1 overflow-hidden">
                ...
                <div className="row align-items-center justify-content-between">
                    <div className="col-xl-6 col-lg-7">
                        <div className="section-9-wrapper mb-64">
                            <h6 className="section-9-subtitle">
                                {t('testimonial_subtitle')}
                            </h6>
                            <h2 className="section-9-title mb-32 text-white">
                                {i18n.language === 'fr'
                                    ? 'Trouvez une maison qui correspond à vos besoins'
                            ...
                            >
                                ...
                                <SwiperSlide>
                                    <div className="testimonial-10-wrapper">
                                        <h4 className="testimonial-10-title font-plusjakarta text-capitalize">
                                            "Great experience"
                                        </h4>
                                        <p className="testimonial-10-paragraph font-inter">
                                            Sasstech hires great people from a
                                            widely variety of backgrounds, which
                                            simply makes our company stronger,
                                ...
                                <SwiperSlide>
                                    <div className="testimonial-10-wrapper">
                                        ...
                                        <p className="testimonial-10-paragraph font-inter">
                                            The team went above and beyond to
                                            help me find my dream apartment.
                                            Highly recommended for anyone
                                            looking for quality housing
                                ...
                                <SwiperSlide>
                                    <div className="testimonial-10-wrapper">
                                        ...
                                        <p className="testimonial-10-paragraph font-inter">
                                            From the first consultation to the
                                            final signing, everything was
            ...
            <div className="testimonial-10-bg-shape">
                <img
                    src="assets/images/shapes/testimonial-10-quote.png"
                    alt="quote"
                />
            </div>
        </section>
