...
export const PROFILE_SCHEMA = [
    {
        ...
        label: 'Nom',
        weight: 10,
        validate: (v) => !!v && String(v).trim().length >= 2,
    },
    {
        key: 'email',
        label: 'Email',
        weight: 10,
        validate: (v) => /\S+@\S+\.\S+/.test(String(v || '')),
    },
    {
        key: 'phone',
        label: 'Téléphone',
        weight: 10,
        validate: (v) => !!v && String(v).trim().length >= 6,
    },
    {
        key: 'profile_photo',
    ...
    }, // url/ID/fichier
    {
        ...
        label: 'Adresse',
        weight: 8,
        validate: (v) => !!v && String(v).trim().length >= 5,
    },
    {
        key: 'bio',
        label: 'Bio',
        weight: 5,
        validate: (v) => !!v && String(v).trim().length >= 10,
    },
