...
return [
    'subjects' => [
        ...
        'property_visit_requested' => 'New viewing request — listing :reference',
        'property_visit_confirmation' => 'Your viewing request — listing :reference',
    ...
    'property_visit' => [
        'owner_title' => 'A viewing has been requested',
        'owner_intro' => '**:name** would like to view your listing **:title**.',
        'owner_next' => 'Contact the requester to confirm the time or suggest another appointment.',
        'visitor_title' => 'Your viewing request is recorded',
        'visitor_intro' => 'Your request to view **:title** has been sent to the owner.',
        'visitor_next' => 'The owner will contact you directly to confirm the appointment. The requested time remains pending until then.',
        'date' => 'Requested time',
        'phone' => 'Phone',
        'email' => 'Email',
        'message' => 'Message',
