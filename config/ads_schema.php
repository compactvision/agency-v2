    ...
    1 => [
        ...
        'sale' => [
            ...
            'optional' => [
                ...
                'construction_year' => 'integer|min:1800',
                'renovation_year' => 'integer|min:1800',
                'furnished' => 'boolean',
                'floor' => 'integer|min:0',
                'total_floors' => 'integer|min:1',
                'plot_surface' => 'numeric|min:0',
                'built_surface' => 'numeric|min:0',
                'garage_size' => 'numeric|min:0',
                'elevator' => 'boolean',
                'parking' => 'boolean',
                'garden' => 'boolean',
                ...
                'cellar' => 'boolean',
                'attic' => 'boolean',
                'condition' => ['new', 'good', 'to_renovate', 'old', 'renovated', 'renovation_needed'],
            ],
        ],
